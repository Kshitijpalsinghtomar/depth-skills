...
**Note:** This BRANCH step is for problem exploration — it helps you understand the solution space. For deeper solution comparison with stress-testing, use DIVERGE as a follow-up skill.
